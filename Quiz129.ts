...
const traditionalVsArrow = {
    ...
    traditionalFunction: function () {
     return  console.log("Traditional function:", this.value); // 'this' refers to traditionalVsArrow object
    },
    arrowFunction: () => {
     return console.log(`Arrow function:, ${this.value}||""`); /* 'this' is not bound to traditionalVsArrow object but to the scope in which 
